  ...
  return (
    <section>
      <H_R_Header
        ...
        className="mt-18 relative md:hidden"
      ...
      <H_R_Header
        title="Join our team of dedicated legal professionals."
        isLabelAvl={false}
        label="Careers at pearlaw corporate"
        className="mt-18 relative hidden md:flex md:flex-col"
        labelStyles="text-accent pt-16"
        imgUrl="/join-our-team/career.jpg"
        imgStyles="w-full h-full aspect- video object-cover absolute md:objct-cover blur-2xl md:blur-none brightness-30 object-bottom"
        titleStylesOveride="mb-0 pb-22 text-xl md:text-xl! md:max-w-2xl md:mx-auto text-white font-normal px-3"
      />
      ...
      <LetDiscuss
        ...
        className="bg-linear-to-l to-[#2B2B2B] from-0% from-[#1E223F] to-60% font-montserrat "
        title="Follow us on social media for the latest updates on job openings and firm news"
        isLabelAvl={false}
        labelStyles="pt-12 text-white"
        titleStylesOveride="px-0 text-2xl md:font-medium md:text-sm! md:max-w-md md:mx-auto   text-white "
